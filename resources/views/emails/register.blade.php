...
<body style="margin: 0; padding: 0;">
    ...
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td bgcolor="#ffffff" align="center" style="padding: 0px 15px 30px 15px;" class="section-padding">
                                        ...
                                        <table role="presentation" width="100%" border="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    class="padding-copy">Hai, {{ $user->name }}</td>
                                            </tr>
                                            <tr>
                                                <td align="center"
                                                    style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;"
                                                    class="padding-copy">Terima Kasih telah mendaftar. Selamat Bergabung
                                                    di Langkah Education. Silahkan verifikasi email anda</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                            ...
                                            <tr>
                                                <td align="center" style="padding: 25px 0 0 0;" class="padding-copy">
                                                    <table role="presentation" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center"><a
                                                                    href="{{ route('user.verify', $user->activate_token) }}"
                                                                    target="_blank"
