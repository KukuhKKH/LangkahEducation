...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('author.update', $author->user->id) }}" id="form" method="post"
                ...
                <div class="col-xl-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            value="{{ $author->user->name }}" placeholder="Nama / username">
                        @error('name')
                ...
                <div class="col-xl-6">
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                            value="{{ $author->user->email }}" placeholder="Email">
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-xl-6">
                    <div class="form-group">
                        ...
                        <select name="is_active" class="form-control @error('is_active') is-invalid @enderror"
                            ...
                            <option value="0" {{ ($author->user->is_active == 0) ? 'selected' : '' }}>Tidak Aktif
                            </option>
                        </select>
                        @error('is_active')
                        <span class="invalid-feedback" role="alert">
            ...
            <div class="row">
                <div class="col-xl-6">
                    @if ($author->user->foto)
                    <img src="{{ asset('upload/users/'.$author->user->foto) }}" alt="{{ $author->user->name }}"
