   ...
   <div class="card-header py-3">
      <div class="d-flex justify-content-between">
         ...
         <div class="btn-group btn-group-md">
            <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#modalData"><i class="fa fa-plus"></i> Tambah Superadmin</button>
         </div>
      </div>
   </div>
   <div class="card-body">
               ...
               <tr>
                  ...
                  <td>
                     @if (auth()->user()->id != $value->id)
                        <form action="{{ route('superadmin.destroy', $value->id) }}" method="POST" id="form-{{ $value->id }}">
                           @csrf
                           @method("DELETE")
