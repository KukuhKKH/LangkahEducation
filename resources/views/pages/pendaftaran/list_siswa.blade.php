               ...
               if(data.length > 0) {
                  ...
                  data.forEach(element => {
                     ...
                     html += `<tr>
                              ...
                              <td>${tgl}</td>
                              <td><a href="${URL}/${element.id}/${element.paket.slug}/${element.user.id}/detail?kelompok=${element.paket.temp[0].kelompok_passing_grade_id}&prodi-1=${element.paket.temp[0].passing_grade_id}&prodi-2=${element.paket.temp[1].passing_grade_id}"><i class="fas fa-eye"></i></a></td>
                           </tr>`
                  })
