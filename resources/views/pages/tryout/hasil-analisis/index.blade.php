                        ...
                        <tbody>
                            ...
                            @if (in_array($value->id, $hasil_to_kategori_id))
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('mentoring.pembahasan',['paket_id' => $to_detail->tryout_paket_id, 'kategori_id' =>  $to_detail->tryout_kategori_soal_id, 'hasil_id' => $to_detail->tryout_hasil_id]) }}"
