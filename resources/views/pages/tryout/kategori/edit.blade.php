...
@section('title', "Edit Kategori Tryout - ".$kategori->nama)

@section('content')
   <h1 class="h3 mb-2 text-gray-800">Edit Kategori Tryout - {{ $kategori->nama }}</h1>

   <div class="card shadow mb-4">
      <div class="card-header py-3">
          <div class="d-flex justify-content-between mb-1">
          <h6 class="m-0 font-weight-bold text-primary">Edit Kategori Tryout - {{ $kategori->nama }}</h6>
          </div>
      </div>
      <div class="card-body">
