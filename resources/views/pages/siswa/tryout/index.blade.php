            ...
            <div class="card mb-2">
                ...
                <div class="card-body">
                    ...
                    @if ($today > $value->tgl_awal && $today < $value->tgl_akhir)
                        ...
                        @endphp
                            @if (count($prodi) > 0)
                            <a class="btn btn-light btn-block mt-4" href="{{ route('tryout.hasil', ['kelompok' => $prodi[0]->kelompok_passing_grade_id, 'slug' => $value->slug, 'prodi-1' => $prodi[0]->passing_grade_id, 'prodi-2' => $prodi[1]->passing_grade_id]) }}">Hasil Analisis</a>    
                            @else
                            <a class="btn btn-light btn-block mt-4" href="{{ route('tryout.hasil', ['slug' => $value->slug]) }}">Hasil Analisis</a>
                            @endif
                        @else
