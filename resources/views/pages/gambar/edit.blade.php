   ...
   <div class="card-body">
      <form action="{{ route('gambar.update', $gambar->id) }}" id="form" method="post" enctype="multipart/form-data">
         ...
         <div class="row">
            ...
            <div class="col-6">
               <div class="form-group">
                  ...
                  <input type="file" class="form-control @error('gambar') is-invalid @enderror" name="foto" accept="image/*">
                  @error('foto')
                  <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                  </span>
         ...
         <div class="row">
            <div class="col-6">
               @if ($gambar->gambar)
                  <img src="{{ asset('upload/soal/'.$gambar->gambar) }}" alt="{{ $gambar->nama }}" class="img-fluid w-100">
               @endif
            </div>
            <div class="col-6">
