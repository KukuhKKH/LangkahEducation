                ...
                <div class="row mb-4 justify-content-end align-items-center">
                    <div class="col-xl-5">
                        <div class="input-group">
                            <input type="text" name="keyword" class="form-control" placeholder="Masukkan Nama Role" aria-label="Masukkan Nama Role" aria-describedby="basic-addon2">
                    ...
                    <div class="col-xl-auto">
                      <a href="{{ route('role.index') }}" class="btn btn-lght text-danger my-1">Refresh</a>
                    </div>
                </div>
            </form>
